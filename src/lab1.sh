...
echo "Sample content for file1" > "${PROJECT_DIR}/data/file1.txt"
echo "Sample content for file2" > "${PROJECT_DIR}/data/file2.txt"
echo "Sample content for file3" > "${PROJECT_DIR}/data/file3.txt"
echo "Sample content for file4" > "${PROJECT_DIR}/data/file4.txt"
echo "Sample content for file5" > "${PROJECT_DIR}/data/file5.txt"
...
du -a "${PROJECT_DIR}" | sort -rh | head -10
